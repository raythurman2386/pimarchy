...
3.  Follow the interactive prompts:
    - **Remove packages?** (y/N) — If you select **y**, Hyprland, Waybar, Foot, and other packages will be removed.
    - **Remove Docker?** (y/N) — Choose whether to remove Docker and its repositories.
    - **Remove Raven + Ollama?** (y/N) — Choose whether to remove the Raven AI agent and Ollama inference server.
