...
-   Add external repositories (Debian Sid for the Hyprland stack — pinned; Docker CE is added only when you install the dev module).
-   Download default apps via official install scripts (Zed, Raven, Ollama).
